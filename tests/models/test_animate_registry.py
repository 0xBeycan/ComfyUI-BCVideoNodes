"""The animate family of the model registry: the Wan Animate and SCAIL-2 adapters, registered by their
...
def test_animate_family_in_registration_order():
    assert registry.names("animate") == ["WanAnimateToVideo", "WanAnimate2ToVideo", "WanSCAILToVideo"]
