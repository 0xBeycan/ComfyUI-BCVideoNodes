...
same keys in the same order, so the annotations cannot drift from POSE_ROW, MASK_ROW and
PREPROCESS_ROW (tests/pipelines/test_guard_split.py ties the tuples to the metrics JSON):
